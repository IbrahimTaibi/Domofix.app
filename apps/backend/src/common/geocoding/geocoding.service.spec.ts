...
describe('GeocodingService', () => {
  ...
  beforeEach(() => { (global as any).fetch = jest.fn(async () => ({ json: async () => [{ lat: '36.8', lon: '10.18', display_name: 'Mock Address' }] })) })
  ...
  it('returns lat/lon/fullAddress on success', async () => {
    ...
    expect(res).toMatchObject({ latitude: 36.8, longitude: 10.18, fullAddress: 'Mock Address' })
  })
