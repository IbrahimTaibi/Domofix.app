    ...
    <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          Développez votre activité avec <span className="text-primary-600">Domofix</span>
          </h2>
        ...
        >
          <div className="relative">
            ...
            <p className="text-sm text-gray-600">Des outils concrets pour centraliser votre travail — même hors Domofix</p>
                    </div>
            ...
            <p className="text-sm text-gray-600">Centralisez les demandes venant de Domofix, téléphone, e‑mail ou réseaux.</p>
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5" />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 mb-6 max-w-xl mx-auto">
              Rejoignez des milliers de prestataires qui grandissent avec Domofix. Commencez votre mois gratuit dès aujourd’hui et découvrez la simplicité de gestion.
            </p>
