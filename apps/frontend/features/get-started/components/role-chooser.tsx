            ...
            >
              {selected === "customer" ? (
                <div className="grid sm:grid-cols-2 gap-6 items-start">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Pourquoi les clients choisissent Domofix</h3>
                ...
                <div className="grid sm:grid-cols-2 gap-6 items-start">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Pourquoi les prestataires rejoignent Domofix</h3>
                    <ul className="space-y-2 text-sm text-gray-700">
