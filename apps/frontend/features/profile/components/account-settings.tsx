...
export default function AccountSettings({ user }: AccountSettingsProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-md shadow-sm border border-gray-200 p-4">
        <h2 className="text-base font-semibold text-gray-900 mb-4">Aperçu de la sécurité</h2>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-2 bg-green-50 rounded-md border border-green-200">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm font-medium text-green-800">Mot de passe</p>
                <p className="text-xs text-green-600">Mot de passe robuste défini</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between p-2 bg-gray-50 rounded-md border border-gray-200">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm font-medium text-gray-700">Activité de connexion</p>
                <p className="text-xs text-gray-500">Voir les sessions récentes</p>
              </div>
            </div>
            <Button variant="outline" size="sm">
              Voir
      ...
      <div className="bg-white rounded-md shadow-sm border border-gray-200 p-4">
        ...
        <div className="space-y-2">
          <Button variant="outline" size="sm" className="w-full justify-start text-blue-600 border-blue-200 hover:bg-blue-50">
            <svg className="w-3.5 h-3.5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Button variant="outline" size="sm" className="w-full justify-start text-yellow-600 border-yellow-200 hover:bg-yellow-50">
            <svg className="w-3.5 h-3.5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
